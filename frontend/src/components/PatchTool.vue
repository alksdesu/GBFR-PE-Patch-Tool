...
import SummonMemoryGenerator from './SummonMemoryGenerator.vue'
...
<template>
  <div class="app-window">
    ...
    <main v-else-if="activeTab === 'summon'" class="container" style="--wails-draggable:no-drag">
      <SummonMemoryGenerator @status="showStatus" />
    </main>
